...
with st.sidebar:
     st.sidebar.image("C:/Users/Viney Acsa Sam/OneDrive/Desktop/Visual Studio/Airbnb/airbnb.jpg", use_column_width=False)
     ...
     Mar_list = df['List_Mar'].drop_duplicates().dropna().tolist()
     ...
     if not filtered_data.empty:
      ...
      selected_area = st.multiselect("Select Area", area_list)
